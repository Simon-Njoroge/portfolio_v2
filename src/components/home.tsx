...
const Home = () => {
    ...
    return (
        <>
            <div className="text-white block sm:block md:flex gap-2 ">
                <div>
                    ...
                    <TypeAnimation
                        ...
                        repeat={Infinity}
                    />
                    <div className='block  w-full sm:block md:flex gap-5 justify-center  bg-gray-800 mt-5 rounded-md '>
                        {
                ...
                {/* folders */}
                <div>
                    <img src={me} alt="" className='mt-5 rounded border-t-2 md:border-t-2 cursor-pointer relative hover:-top-2' />
                </div>
            </div>
            <br />
            <br />
